...
namespace BaustellenBob.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260309131401_AddMaterialEntryWorkReportLink")]
    partial class AddMaterialEntryWorkReportLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaustellenBob.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BaustellenBob.Domain.Entities.Project", b =>
                {
                    b.HasOne("BaustellenBob.Domain.Entities.Customer", "Customer")
                        .WithMany("Projects")
